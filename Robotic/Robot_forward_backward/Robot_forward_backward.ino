/*
  ...
  The robot will move forward, stop, reverse, and stop again, in a repeating cycle.
...
void loop() {
  ...
  digitalWrite(right_direction, LOW);    // Set right motor to backward
  analogWrite(left_power, 100);
  digitalWrite(left_direction, LOW);     // Set left motor to backward
